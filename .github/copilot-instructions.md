...
**Proxy Mode**: OpenHQM can operate as an asynchronous reverse proxy, forwarding requests to configured backend endpoints with support for multiple authentication methods, transparent header forwarding, and full response capture. See [PROXY_MODE.md](../PROXY_MODE.md) for details.
