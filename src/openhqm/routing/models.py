...
class Route(BaseModel):
    ...
    match_value: str | None = Field(default=None, description="Value to match for routing")
    match_pattern: str | None = Field(default=None, description="Regex pattern to match")
