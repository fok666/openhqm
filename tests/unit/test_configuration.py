...
class TestProxySettings:
    ...
    def test_proxy_settings_with_default_url(self):
        ...
        settings = ProxySettings(
            enabled=True,
            default_endpoint="http://default.example.com"
        )
...
class TestRoutingSettings:
    ...
    def test_routing_settings_with_file(self):
        ...
        settings = RoutingSettings(
            enabled=True,
            config_path="/etc/openhqm/routing.yaml"
        )
    ...
    def test_settings_with_all_features_enabled(self):
        ...
        settings = Settings(
            ...
            proxy=ProxySettings(
                enabled=True,
                endpoints={
                    "api": EndpointConfig(url="http://api.example.com")
                }
            ),
            routing=RoutingSettings(
                enabled=True,
                config_dict={"version": "1.0", "routes": []}
            ),
...
class TestConfigurationSecurity:
    ...
    def test_api_key_handling(self):
        ...
        config = EndpointConfig(
            url="http://api.example.com",
            auth_type="api_key",
            auth_token="secret-api-key-12345"
        )
