...
async def test_worker_processes_batch(worker, mock_queue, mock_processor):
    ...
    messages = [
        {"correlation_id": f"test-{i}", "payload": {}, "metadata": {}, "timestamp": "2026-02-08T10:00:00Z"}
        for i in range(5)
    ]
...
async def test_worker_concurrent_processing_isolation(worker, mock_processor):
    ...
    message1 = {"correlation_id": "concurrent-1", "payload": {}, "metadata": {}, "timestamp": "2026-02-08T10:00:00Z"}
    message2 = {"correlation_id": "concurrent-2", "payload": {}, "metadata": {}, "timestamp": "2026-02-08T10:00:00Z"}
